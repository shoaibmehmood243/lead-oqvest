    ...
    const handleInputChange = (event) => {
        ...
        if (Number(value)) {
            ...
            if(price > 1000000) {
                ...
                setFormData({...formData, remainingMortage: 1000000})
            } else if(price === 55000) {
                setPriceRange(55000);
                setFormData({...formData, remainingMortage: 55000})
            } else {
                setPriceRange(price);
    ...
    return (
        <div>
            <div className='w-full md:w-11 lg:w-11 m-auto text-center'>
                <h1 className="text-900 text-2xl md:text-4xl mb-6">What is the remaining 1st mortgage balance?</h1>

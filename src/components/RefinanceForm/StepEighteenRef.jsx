        ...
        <div>
            <div className='w-10 md:w-8 m-auto text-center'>
                ...
                <form onSubmit={handleSubmit}>
                    <div>
                        <InputMask mask="(999) 999-9999" value={formData.number} onChange={(e)=> setFormData({...formData, number: e.target.value})} type="text" className="p-inputtext-lg w-10 md:w-8 lg:w-6" placeholder="Enter your phone number" />
                    </div>

      ...
      return (
          <div>
              <div className='w-full lg:w-11 m-auto text-center'>
                  ...
                  <form>
                  <div>
                      <InputText value={formData.email} onChange={(e)=> setFormData({...formData, email: e.target.value})} type="text" className="p-inputtext-lg w-12 md:w-8 lg:w-8" placeholder="Enter your email here" />
                  </div>

          ...
          <div>
              <div className='w-full lg:w-11 m-auto text-center'>
                  ...
                  <div className=" animate">
                      <InputText value={formData.email} onChange={(e)=> setFormData({...formData, email: e.target.value})} type="text" className="p-inputtext-lg w-10 md:w-8 lg:w-8" placeholder="Enter your email here" />
                  </div>
